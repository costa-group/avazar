...
(define-fun main ((v_0 FFp) (v_8 FFp) (v_1 FFp) (v_2 FFp) (v_3 FFp) (v_4 FFp) (v_5 FFp) (v_6 FFp) (v_7 FFp)) Bool
  (and 
    (@IsZero_0 v_0 v_1 v_2 v_3 v_4 v_5 v_6 v_7)
    (= v_8 v_1)
  )
)
...
(assert 
  (main v_0 v_8 v_1 v_2 v_3 v_4 v_5 v_6 v_7)
)
